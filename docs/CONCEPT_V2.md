...
Status (2026-08-31): P1 ✅ · P2 ✅ (extension + `network_failure` layout) · P3 ✅ (agent: files + piped output) · P4 ✅ (dismissal learning, persisted across reloads/restarts; cross-site templates pending). Details in `STATUS.md`.
